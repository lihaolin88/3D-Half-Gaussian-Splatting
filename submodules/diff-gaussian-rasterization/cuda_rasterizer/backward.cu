	...
	float* __restrict__ dL_dcolors)
{
	...
	for (int i = 0; i < rounds; i++, toDo -= BLOCK_SIZE)
	{
		...
		for (int j = 0; !done && j < min(BLOCK_SIZE, toDo); j++)
		{
            ...
            const float temp = (norm_use.x*d.x + norm_use.y*d.y)*denomi_z;
            ...
            const float dG1_dx = (0.5f*W)*(-(con_o1.x*d.x + con_o1.y*d.y)*G1 + exp_part*dev_erf1*(norm_use.x)*denomi_z); //(-(con_o1.x * d.x + con_o1.y * d.y)*G1 + exp_part*dev_erf1*(1.4142135f*norm_use.x/(W*norm_use.z))); //(2/W)*(-(con_o1.x*(con_o1.x * d.x + con_o1.y * d.y))*G1 *(2.0f*3.1415926f) + exp_part*((norm_use.x*con_o1.x)*(1.0f - tanh_result1*tanh_result1)/(1.4142135f*norm_use.z)))/(2.0f*3.1415926f);//exp_part*((2*d.x+2*d.x*tanh_result1+(1.0f-tanh_result1*tanh_result1)*norm_use.x/(1.4142135f*norm_use.z))/(2*3.1415926f));
            const float dG2_dx = (0.5f*W)*(-(con_o1.x*d.x + con_o1.y*d.y)*G2 - exp_part*dev_erf2*(norm_use.x)*denomi_z); //(-(con_o1.x * d.x + con_o1.y * d.y)*G2 - exp_part*dev_erf2*(1.4142135f*norm_use.x/(W*norm_use.z))); //(2/W)*(-(con_o1.x*(con_o1.x * d.x + con_o1.y * d.y))*G2 *(2.0f*3.1415926f) + exp_part*((norm_use.x*con_o1.x)*(1.0f - tanh_result2*tanh_result2)/(-1.4142135f*norm_use.z)))/(2.0f*3.1415926f);//exp_part*((2*d.x+2*d.x*tanh_result2+(1.0f-tanh_result2*tanh_result2)*norm_use.x/(1.4142135f*norm_use.z))/(2*3.1415926f));
            const float dG1_dy = (0.5f*H)*(-(con_o1.z*d.y + con_o1.y*d.x)*G1 + exp_part*dev_erf1*(norm_use.y)*denomi_z); //(-(con_o1.z * d.y + con_o1.y * d.x)*G1 + exp_part*dev_erf1*(1.4142135f*norm_use.y/(H*norm_use.z))); //(2/H)*(-(con_o1.y*(con_o1.x * d.x + con_o1.y * d.y) + con_o1.z*(con_o1.z * d.y))*G1 *(2.0f*3.1415926f) + exp_part*((norm_use.x*con_o1.y + norm_use.y*con_o1.z)*(1.0f - tanh_result1*tanh_result1)/(1.4142135f*norm_use.z)))/(2.0f*3.1415926f);//exp_part*((2*d.y+2*d.y*tanh_result1+(1.0f-tanh_result1*tanh_result1)*norm_use.y/(1.4142135f*norm_use.z))/(2*3.1415926f));
            const float dG2_dy = (0.5f*H)*(-(con_o1.z*d.y + con_o1.y*d.x)*G2 - exp_part*dev_erf1*(norm_use.y)*denomi_z); //(-(con_o1.z * d.y + con_o1.y * d.x)*G2 - exp_part*dev_erf2*(1.4142135f*norm_use.y/(H*norm_use.z))); //(2/H)*(-(con_o1.y*(con_o1.x * d.x + con_o1.y * d.y) + con_o1.z*(con_o1.z * d.y))*G2 *(2.0f*3.1415926f) + exp_part*((norm_use.x*con_o1.y + norm_use.y*con_o1.z)*(1.0f - tanh_result2*tanh_result2)/(-1.4142135f*norm_use.z)))/(2.0f*3.1415926f);//exp_part*((2*d.y+2*d.y*tanh_result2+(1.0f-tanh_result2*tanh_result2)*norm_use.y/(1.4142135f*norm_use.z))/(2*3.1415926f));

            const float dG1_dcx = -(0.5f*d.x*d.x)*G1; //+ exp_part*dev_erf1*(norm_use.x*d.x)*denomi_z; //-0.5f*d.x*d.x*G1; //(-d.x*(con_o1.x * d.x + con_o1.y * d.y)*G1 *(2.0f*3.1415926f) + exp_part*(((norm_use.x * d.x)/(1.4142135f*norm_use.z)*(1.0f - tanh_result1*tanh_result1))))/(2.0f*3.1415926f);
            const float dG2_dcx = -(0.5f*d.x*d.x)*G2; //- exp_part*dev_erf1*(norm_use.x*d.x)*denomi_z; //-0.5f*d.x*d.x*G2; //(-d.x*(con_o1.x * d.x + con_o1.y * d.y)*G2 *(2.0f*3.1415926f) + exp_part*(((norm_use.x * d.x)/(-1.4142135f*norm_use.z)*(1.0f - tanh_result2*tanh_result2))))/(2.0f*3.1415926f);
            const float dG1_dcy = -(0.5f*d.x*d.y)*G1; //+ exp_part*dev_erf1*(norm_use.x*d.y)*denomi_z; //-d.x*d.y*G1; //(-(d.y*(con_o1.x * d.x + con_o1.y * d.y))*G1 *(2.0f*3.1415926f) + exp_part*(((norm_use.x * d.y)/(1.4142135f*norm_use.z)*(1.0f - tanh_result1*tanh_result1))))/(2.0f*3.1415926f);
            const float dG2_dcy = -(0.5f*d.x*d.y)*G2; //- exp_part*dev_erf1*(norm_use.x*d.y)*denomi_z; //-d.x*d.y*G2; //(-(d.y*(con_o1.x * d.x + con_o1.y * d.y))*G2 *(2.0f*3.1415926f) + exp_part*(((norm_use.x * d.y)/(-1.4142135f*norm_use.z)*(1.0f - tanh_result2*tanh_result2))))/(2.0f*3.1415926f);
            const float dG1_dcz = -(0.5f*d.y*d.y)*G1; //+ exp_part*dev_erf1*(norm_use.y*d.y)*denomi_z; //-0.5f*d.y*d.y*G1; //(-d.y*(con_o1.z * d.y)*G1 *(2.0f*3.1415926f) + exp_part*(((norm_use.y * d.y)/(1.4142135f*norm_use.z)*(1.0f - tanh_result1*tanh_result1))))/(2.0f*3.1415926f);
            const float dG2_dcz = -(0.5f*d.y*d.y)*G2; //- exp_part*dev_erf1*(norm_use.y*d.y)*denomi_z; //-0.5f*d.y*d.y*G2; //(-d.y*(con_o1.z * d.y)*G2 *(2.0f*3.1415926f) + exp_part*(((norm_use.y * d.y)/(-1.4142135f*norm_use.z)*(1.0f - tanh_result2*tanh_result2))))/(2.0f*3.1415926f);

            const float dG1_dn1 =  exp_part*dev_erf1*d.x*denomi_z; //(con_o1.x*d.x + con_o1.y*d.y)*denomi_z;//(1.4142135f*d.x/(W*norm_use.z)); //(exp_part)*(1.0f - tanh_result1*tanh_result1)*((con_o1.x * d.x + con_o1.y * d.y)/(1.4142135f*norm_use.z))/(2.0f*3.1415926f);//exp_part*(1.0f-tanh_result1*tanh_result1)*d.x/(1.4142135f*norm_use.z) / (2*3.1415926f);
            const float dG1_dn2 =  exp_part*dev_erf1*d.y*denomi_z; //(con_o1.z*d.y)*denomi_z;//(1.4142135f*d.y/(H*norm_use.z)); //(exp_part)*(1.0f - tanh_result1*tanh_result1)*((con_o1.z * d.y)/(1.4142135f*norm_use.z))/(2.0f*3.1415926f);//exp_part*(1.0f-tanh_result1*tanh_result1)*d.y/(1.4142135f*norm_use.z) / (2*3.1415926f);
            const float dG1_dn3 =  -exp_part*dev_erf1*((norm_use.x*d.x + norm_use.y*d.y)/(sqrt(2.f)*norm_use.z*norm_use.z)); //((norm_use.x*usex + norm_use.y*usey)/(1.4142135f*norm_use.z*norm_use.z));//(-1.4142135f*(norm_use.x*d.x/W + norm_use.y*d.y/H)/(norm_use.z*norm_use.z)); //(exp_part)*(1.0f - tanh_result1*tanh_result1)*((norm_use.x*(con_o1.x * d.x + con_o1.y * d.y) + norm_use.y*(con_o1.z * d.y))/(-1.4142135f*norm_use.z*norm_use.z))/(2.0f*3.1415926f);//exp_part*(1.0f-tanh_result1*tanh_result1)*(norm_use.x*d.x + norm_use.y*d.y)/(1.4142135f*norm_use.z) / (2*3.1415926f);
